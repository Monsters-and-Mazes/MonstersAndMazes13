...
/datum/map_config
	// Metadata
	var/config_filename = "_maps/mnm.json"
	...
	var/map_name = "Overland"
	var/map_path = "map_files/MonstersAndMazes"
	var/map_file = list("MnM_1.dmm")
	...
	var/year_offset = -940 //The offset of ingame year from the actual IRL year. You know you want to make a map that takes place in the 90's. Don't lie.
